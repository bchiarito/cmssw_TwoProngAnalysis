...
twoprongModNtuplizer = cms.EDAnalyzer('TwoProngAnalyzer',
                                  ...
                                  twoprong_optionalExtraTrack = cms.untracked.bool(True), # from False
                                  twoprong_flipAsymReq = cms.untracked.bool(False),
                                  twoprong_chargedHadronPairMinDR = cms.untracked.double(0.1), # from 0.05
                                  twoprong_chargedHadronMinPt = cms.untracked.double(3.0),
                                  twoprong_photonPtCut = cms.untracked.double(3.0),
                                  twoprong_photonPhiBoxSize = cms.untracked.double(0.4), # from 0.2
                                  twoprong_photonEtaBoxSize = cms.untracked.double(0.1), # from 0.05
                                  ...
                                  includeAsymTwoProngs = cms.untracked.bool(False),
                                  # z study related
