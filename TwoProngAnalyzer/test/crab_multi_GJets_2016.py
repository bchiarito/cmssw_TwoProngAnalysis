...
#config.Data.outLFNDirBase = '/store/user/%s/cms_area/twoprong/trees/no_filter/gjets2016/' % (getUsernameFromSiteDB())
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/trees/no_filter/gjets2016/'
