...
config.General.workArea = 'crab_multi_twoprongntuplizer_QCD_FNAL'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/noreplica/twoprong/ztagandprobe/Nov12_trees/QCD/'
