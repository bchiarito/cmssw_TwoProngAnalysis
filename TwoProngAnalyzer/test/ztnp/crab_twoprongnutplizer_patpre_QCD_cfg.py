...
config.General.workArea = 'crab_multi_twoprongntuplizer_patpre_QCD'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/ztagandprobe/Nov26_trees/patpre/QCD/'
