...
config.General.workArea = 'crab_multi_validate_xsec_QCD'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/ztagandprobe/Nov27_trees/validateQCD/'
