...
config.General.workArea = 'crab_multi_twoprongntuplizer_QCD_reg2prong'
config.section_('JobType')
config.JobType.psetName = 'cmssw_twoprongntuplizer_cfg.py'
config.JobType.pyCfgParams = ['globalTag=mc2016', 'tagandprobeSelection=True', 'mcInfo=True']
config.JobType.pluginName = 'Analysis'
config.section_('Data')
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/ztagandprobe/nofiltering/trees/reg2prong/QCD/'
