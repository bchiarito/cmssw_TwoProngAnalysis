...
config.General.workArea = 'crab_multi_validate_twoprongntuplizer_dec23_fullDY'
config.section_('JobType')
config.JobType.psetName = '../../cmssw_twoprongntuplizer_cfg.py'
config.JobType.pyCfgParams = ['globalTag=mc2016', 'isDYll=True', 'mcInfo=True', 'standardTwoProng=True', 'tauModifiedTwoProng=True', 'includeCands=True', 'includeTauTau=True']
config.JobType.pluginName = 'Analysis'
config.section_('Data')
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Dec23_trees/fullDY/'
...
if __name__ == '__main__':
    ...
    config.Data.outputDatasetTag = "DY1_50"
    ...
    config.Data.outputDatasetTag = "DY2_50"
    ...
    config.Data.outputDatasetTag = "DY3_50"
    ...
    config.Data.outputDatasetTag = "DY4_50"
