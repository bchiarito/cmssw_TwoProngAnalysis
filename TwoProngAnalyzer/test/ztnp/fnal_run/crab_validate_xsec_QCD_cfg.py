...
config.General.workArea = 'crab_multi_validate_xsec_dec19_QCD'
config.section_('JobType')
config.JobType.psetName = '../../cmssw_twoprongntuplizer_cfg.py'
config.JobType.maxJobRuntimeMin = 2630 # 44 hrs
config.JobType.pyCfgParams = ['globalTag=mc2016', 'mcInfo=True', 'standardTwoProng=False', 'includeCands=False']
config.JobType.pluginName = 'Analysis'
config.section_('Data')
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Dec19_trees/validateQCD/'
