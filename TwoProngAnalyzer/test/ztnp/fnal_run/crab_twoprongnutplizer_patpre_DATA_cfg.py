...
config.General.workArea = 'crab_multi_twoprongntuplizer_nov29_patpre_DATA'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Nov29_trees/patpre/DATA/'
