...
config.General.workArea = 'crab_multi_twoprongntuplizer_jan10_mumu_DATA'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Jan10_trees/mumu/DATA/'
