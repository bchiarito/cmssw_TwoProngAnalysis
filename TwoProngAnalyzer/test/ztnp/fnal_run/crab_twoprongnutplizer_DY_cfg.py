...
config.General.workArea = 'crab_multi_twoprongntuplizer_nov29_DY'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Nov29_trees/regpre/DY/'
