...
config.General.workArea = 'crab_multi_twoprongntuplizer_nov29_mumu_QCD'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/twoprong/ztagandprobe/Nov29_trees/mumu/QCD/'
