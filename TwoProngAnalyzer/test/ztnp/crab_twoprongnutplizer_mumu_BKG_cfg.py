...
config.General.workArea = 'crab_multi_twoprongntuplizer_nov28_mumu_BKG'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/ztagandprobe/Nov28_trees/mumu/BKG/'
