...
config.General.workArea = 'crab_multi_QCD_2015_Feb6'
...
config.Data.outLFNDirBase = '/store/user/%s/cms_area/twoprong/trees/no_filter/qcd2015/Feb6/' % (getUsernameFromSiteDB())
