...
// Fri Sep 21 13:26:51 2012 by ROOT version 5.34/00
...
#ifndef CutEfficiencyLoop_h
#define CutEfficiencyLoop_h
...
public :
   ...
   TH1F*  h_Diphoton_Minv_Acceptance;
   TH1F*  h_Diphoton_Minv_HoverE_After;
   TH1F*  h_Diphoton_Minv_TrackIso_After;
   TH1F*  h_Diphoton_Minv_HcalIso_After;
   TH1F*  h_Diphoton_NoPixelSeed_After; 
   TH1F*  h_Diphoton_Minv_EcalIso_After;
   TH1F*  h_Diphoton_Minv_SigmaIetaIeta_After;
   
 
   TH1F*  h_Diphoton_Minv_HoverE_Before;
   TH1F*  h_Diphoton_Minv_TrackIso_Before;
   TH1F*  h_Diphoton_Minv_HcalIso_Before;
   TH1F*  h_Diphoton_NoPixelSeed_Before;
   TH1F*  h_Diphoton_Minv_EcalIso_Before;
   TH1F*  h_Diphoton_Minv_SigmaIetaIeta_Before;
   ...
   CutEfficiencyLoop(TTree *tree=0);
   virtual ~CutEfficiencyLoop();
...
#ifdef CutEfficiencyLoop_cxx
CutEfficiencyLoop::CutEfficiencyLoop(TTree *tree) 
: fChain(0) 
, _outfilename(0)
{
...
CutEfficiencyLoop::~CutEfficiencyLoop()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CutEfficiencyLoop::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CutEfficiencyLoop::LoadTree(Long64_t entry)
{
...
void CutEfficiencyLoop::Init(TTree *tree)
{
   ...
   h_Diphoton_Minv_Acceptance = new TH1F("h_Diphoton_Minv_Acceptance","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_HoverE_After = new TH1F("h_Diphoton_Minv_HoverE_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_HoverE_Before = new TH1F("h_Diphoton_Minv_HoverE_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_TrackIso_After = new TH1F("h_Diphoton_Minv_TrackIso_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_TrackIso_Before = new TH1F("h_Diphoton_Minv_TrackIso_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_HcalIso_After = new TH1F("h_Diphoton_Minv_HcalIso_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_HcalIso_Before = new TH1F("h_Diphoton_Minv_HcalIso_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_NoPixelSeed_After = new TH1F("h_Diphoton_NoPixelSeed_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_NoPixelSeed_Before = new TH1F("h_Diphoton_NoPixelSeed_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_EcalIso_After = new TH1F("h_Diphoton_Minv_EcalIso_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_EcalIso_Before = new TH1F("h_Diphoton_Minv_EcalIso_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_SigmaIetaIeta_After = new TH1F("h_Diphoton_Minv_SigmaIetaIeta_After","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);
   h_Diphoton_Minv_SigmaIetaIeta_Before = new TH1F("h_Diphoton_Minv_SigmaIetaIeta_Before","Diphoton Invariant Mass;M_{#gamma#gamma} [GeV/c^{2}]",nMinvbins,Minvmin,Minvmax);

}

Bool_t CutEfficiencyLoop::Notify()
{
...
void CutEfficiencyLoop::Show(Long64_t entry)
{
...
Int_t CutEfficiencyLoop::Cut(Long64_t entry)
{
...
#endif // #ifdef CutEfficiencyLoop_cxx
