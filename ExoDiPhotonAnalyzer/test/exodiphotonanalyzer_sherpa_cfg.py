...
process.diphotonAnalyzer.requireGenEventInfo = True
...
process.diphotonAnalyzer.PFIDCategory = cms.untracked.string("Tight")
...
process.diphotonAnalyzer.PUDataFileName = 'PileupDataDec14thHistogram.root' #DataPileUp
process.diphotonAnalyzer.PUDataHistName = "pileup" #Name of histogram in PUDataFileName Need to be binned to 80

process.diphotonAnalyzer.PUMCFileName = 'PileUpMC_DiPhotonJetsBox_M60_8TeV-sherpa_Summer12_DR53X-PU_S10_START53_V7C-v1_rebinned.root'  #"MC PileUP"
