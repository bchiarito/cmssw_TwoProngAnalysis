...
process.diphotonAnalyzer.requireGenEventInfo = True # ie only tight photons will be written 
...
process.diphotonAnalyzer.PFIDCategory = cms.untracked.string("Medium")
