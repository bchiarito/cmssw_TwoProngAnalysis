...
// Mon Nov 26 14:52:43 2012 by ROOT version 5.32/00
// from TTree fTree/PhotonTree
// found on file: /afs/cern.ch/work/c/charaf/public/diphoton_tree_RSGravToGG_kMpl-001_M-1000_TuneZ2star_8TeV-pythia6_private_Reco_PUSept10th.root
//////////////////////////////////////////////////////////

#ifndef CalcSignalEfficiency_h
#define CalcSignalEfficiency_h
...
class CalcSignalEfficiency {
 public :
  ...
  CalcSignalEfficiency(TTree *tree=0);
  virtual ~CalcSignalEfficiency();
...
#ifdef CalcSignalEfficiency_cxx
CalcSignalEfficiency::CalcSignalEfficiency(TTree *tree)  
{
  ...
  if (tree == 0) {
    ...
    f->GetObject("diphotonSignalMCAnalyzer/fTree",tree);
    ...
    chain->Add("/afs/cern.ch/work/c/charaf/public/diphoton_tree_RSGravToGG_kMpl-001_M-1000_TuneZ2star_8TeV-pythia6_private_Reco_PUSept10th.root/diphotonSignalMCAnalyzer/fTree");
    tree = chain;
#endif // SINGLE_TREE 
  }
  Init(tree);
...
CalcSignalEfficiency::~CalcSignalEfficiency()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t CalcSignalEfficiency::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t CalcSignalEfficiency::LoadTree(Long64_t entry)
{
...
void CalcSignalEfficiency::Init(TTree *tree)
{
...
Bool_t CalcSignalEfficiency::Notify()
{
...
void CalcSignalEfficiency::Show(Long64_t entry)
{
...
Int_t CalcSignalEfficiency::Cut(Long64_t entry)
{
...
#endif // #ifdef CalcSignalEfficiency_cxx
