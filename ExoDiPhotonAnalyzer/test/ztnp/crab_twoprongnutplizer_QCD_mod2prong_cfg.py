...
config.General.workArea = 'crab_multi_twoprongntuplizer_QCD_mod2prong'
config.section_('JobType')
config.JobType.psetName = 'cmssw_twoprongntuplizer_cfg.py'
config.JobType.pyCfgParams = ['globalTag=mc2016', 'tagandprobeSelection=True', 'mcInfo=True', 'twoProngDefinition=2']
config.JobType.pluginName = 'Analysis'
config.section_('Data')
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprong/ztagandprobe/nofiltering/trees/mod2prong/QCD/'
