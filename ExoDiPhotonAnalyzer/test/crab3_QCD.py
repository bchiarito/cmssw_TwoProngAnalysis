...
config.General.workArea = 'qcd_fullrun_trackdr_20_crab3jobs'
config.section_('JobType')
config.JobType.psetName = 'exodiphotonanalyzer_minimal_cfg.py'
config.JobType.pyCfgParams = ['local=False','globalTag=80X_mcRun2_asymptotic_2016_TrancheIV_v6','mcInfo=True','includeCands=True', 'trackDR=0.20']
config.JobType.pluginName = 'Analysis'
config.section_('Data')
config.Data.outLFNDirBase = '/store/user/bchiari1/cms_area/twoprongstudies/trees/qcd/fullrun_trackdr_20/'
