...
config.General.workArea = 'trigeff_jetdata2016_test_crab3jobs'
...
config.Data.outLFNDirBase = '/store/user/bchiari1/noreplica/diphotonProject/scratch/photon_eff_calc_test'
