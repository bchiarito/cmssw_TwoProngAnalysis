...
# coupling, mass, totalXSec, totalEff, nDataObs, nBG, nBGerr
#c = 0.01
modelPointsC0p01 = []
modelPointsC0p01.append(ModelPoint(0.01, 750,  1.023e-02, 30.1475/100, 4, 3.29455, 1.81509))
modelPointsC0p01.append(ModelPoint(0.01, 1000, 2.072e-03, 34.7347/100, 0, 0.44277, 0.66541))
modelPointsC0p01.append(ModelPoint(0.01, 1250, 5.21e-04,  38.7874/100, 0, 0.21078, 0.45911))
modelPointsC0p01.append(ModelPoint(0.01, 1500, 1.604e-04, 42.5412/100, 0, 0.10940, 0.33076))
modelPointsC0p01.append(ModelPoint(0.01, 1750, 5.408e-05, 46.6982/100, 0, 0.04682, 0.21638))
modelPointsC0p01.append(ModelPoint(0.01, 2000, 1.853e-05, 49.1978/100, 0, 0.02463, 0.15695))
modelPointsC0p01.append(ModelPoint(0.01, 3000, 4.703e-07, 54.5872/100, 0, 0.00193, 0.04389))
#c = 0.05
modelPointsC0p05 = []
modelPointsC0p05.append(ModelPoint(0.05, 1750, 1.331e-03, 46.1352/100, 0, 0.04682, 0.21638))
modelPointsC0p05.append(ModelPoint(0.05, 2000, 4.665e-04, 49.1199/100, 0, 0.02463, 0.15695))
modelPointsC0p05.append(ModelPoint(0.05, 2500, 7.226e-05, 52.9777/100, 0, 0.00445, 0.06668))
modelPointsC0p05.append(ModelPoint(0.05, 2750, 2.803e-05, 53.6758/100, 0, 0.00182, 0.04265))
modelPointsC0p05.append(ModelPoint(0.05, 3000, 1.169e-05, 53.6002/100, 0, 0.00193, 0.04389))
#c = 0.1
modelPointsC0p1 = []
modelPointsC0p1.append(ModelPoint(0.1, 2250, 7.04e-04, 51.4743/100, 0, 0.01589, 0.12605))
modelPointsC0p1.append(ModelPoint(0.1, 2500, 2.79e-04, 52.9381/100, 0, 0.00663, 0.08143))
modelPointsC0p1.append(ModelPoint(0.1, 2750, 1.14e-04, 53.6588/100, 0, 0.00321, 0.05667))
modelPointsC0p1.append(ModelPoint(0.1, 3000, 4.68e-05, 53.512/100,  0, 0.00193, 0.04390))
modelPointsC0p1.append(ModelPoint(0.1, 3250, 1.19e-05, 53.5149/100, 0, 0.00326, 0.05711))
modelPointsC0p1.append(ModelPoint(0.1, 3500, 7.7e-05,  52.9363/100, 0, 0.00326, 0.05711))
