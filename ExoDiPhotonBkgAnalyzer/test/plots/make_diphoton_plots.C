...
void make_merged_diphoton_plots(TString sample = "PhotonJet"){
  ...
  for(int ifile=0;ifile<nfiles;ifile++) {
    //    fileNames[ifile] = TString::Format("%s/PhotonJet_%s/histograms_PhotonJet_%s.root",ntupleDir.Data(),labels[ifile].Data(),labels[ifile].Data());
    fileNames[ifile] = TString::Format("%s/histograms_PhotonJet_%s.root",ntupleDir.Data(),labels[ifile].Data(),labels[ifile].Data());
  ...
  TString outFileName = TString::Format("histograms_%s_all.root",setLabel.Data());
  ...
  TString printLabel =  setLabel + "_all";
